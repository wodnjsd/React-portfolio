    ...
    <>
      ...
      <p className="my-2 text-3xl px-10 font-bold  text-gray-900 md:text-center sm:text-4xl pb-10">
        ...
        <div className="lg:flex p-10">
          <div>
            <img src={img4} alt="garden homepage" className="h-full w-full object-cover object-center" />
          </div>
          <div className="flex flex-col justify-center lg:gap-8 lg:pl-5 pt-5 text-left">
            ...
            <p className="text-sm py-2 lg:text-lg text-gray-600">Solo front-end project<br />Built with Typescript, React, Tailwind</p>
            <div className="pr-2 text-xl lg:text-3xl text-gray-500">
              <a href="https://jwfitness.netlify.app/" target="blank"><BsArrowRight /></a>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center lg:gap-8 pt-5 text-left pr-5">
            ...
            <p className="text-sm py-2 lg:text-lg text-gray-600">Solo full-stack project<br />Built with React, Python, PostgreSQL</p>
            <div className="pr-2 text-xl lg:text-3xl text-gray-500">
              <a href="https://toothirty.netlify.app/" target="blank"><BsArrowRight /></a>
              <p className="text-xs">(under reconstruction to become responsive)</p>
            </div>
          </div>
        </div>
        ...
        <div className="lg:flex p-10">
          ...
          <div className="flex flex-col justify-center lg:gap-8 lg:pl-5 pt-5 text-left">
            ...
            <p className="text-sm py-2 lg:text-lg text-gray-600">Group full-stack project<br />Built with MERN </p>
            <div className="pr-2 text-xl lg:text-3xl text-gray-500">
